...
const StoreHome = () => {
  ...
  const [bannerImage , setBannerImage] = useState("/defaultBanner.png");
...
useEffect(() => {
  if (store?.storeDetails?.bannerImage) {
    setBannerImage(store.storeDetails?.bannerImage);
  }
}, [store?.storeDetails?.bannerImage]);
